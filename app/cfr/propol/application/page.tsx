  ...
  const renderCompetency = (c: CompetencyFull) => {
    ...
    return (
      <div className="space-y-2 text-sm">
        ...
        <div className="border rounded p-2">
          <div className="font-medium">Officer Notes (Competency)</div>
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-3/4 p-8">
        <Card>
          <CardHeader>
            <CardTitle>CFR Province Police Inbox</CardTitle>
          </CardHeader>
                  ...
                  <AccordionItem key={app.id} value={String(app.id)}>
                    ...
                    <AccordionContent className="p-4 space-y-4">
                      ...
                      <div className="border rounded p-3 text-sm space-y-2">
                        <div>
                          <b>Forwarded by Firearm Officer:</b> {app.forwarded_by_email || '-'}
                        </div>
                        <div className="text-xs text-muted-foreground">
                          Officer UID: {app.forwarded_by_uid || '-'}
                        </div>
                      ...
                      <div className="flex justify-end pt-2">
                        <Button onClick={() => router.push(`/cfr/propol/application/add-attachment?appId=${app.id}`)}>
                          Next
                        </Button>
                      </div>
                    </AccordionContent>
