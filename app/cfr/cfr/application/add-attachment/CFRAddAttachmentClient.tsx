...
export default function CFRAddAttachmentClient() {
  ...
  const getFileUrl = (path: string) => {
    // You always upload into application-attachments in this file,
    // so keep it consistent.
    return supabase.storage.from('application-attachments').getPublicUrl(path).data.publicUrl
  }
  ...
  if (!appId) return <div className="p-8">Missing appId</div>
