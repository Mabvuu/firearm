// app/cfr/cfr/application/page.tsx
'use client'
...
export default function CFRApplicationsPage() {
  const [apps, setApps] = useState<Application[]>([])
  const [guns, setGuns] = useState<Record<number, Gun | null>>({})
  const [competencies, setCompetencies] = useState<
    Record<number, CompetencyFull | null>
  >({})
                        ...
                        <Button
                          onClick={() =>
                            (window.location.href =
                              `/cfr/cfr/application/add-attachment?appId=${app.id}`)
                          }
                        >
                          Next
                        </Button>
