// app/joc/controller/nav/page.tsx
'use client'
...
export default function NavPage() {
  ...
  const [profile, setProfile] = useState<Profile>({ email: null, role: 'joc.controller' })
  const [greeting, setGreeting] = useState('')

  const navLinks = useMemo(
    () => [
      { href: '/joc/controller/dashboard', label: 'Home' },
          ...
          <div className="space-y-1">
            ...
            <div className="text-sm leading-snug" style={{ color: COLORS.naturalAluminum }}>
              <span className="font-medium">
                {ROLE_LABEL[profile.role ?? 'joc.controller'] ?? 'JOC Controller'}
              </span>
